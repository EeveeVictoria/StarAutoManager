...
| [Stasshe/Pyxis-CodeCanvas](https://github.com/Stasshe/Pyxis-CodeCanvas) | Pyxis is an FULL client-side  IDE that runs in the browser(static site) with Nod... | TypeScript | 45 |
...
| [white-rose27/Vscode-Transparency](https://github.com/white-rose27/Vscode-Transparency) | a nice, hassle-free rice for anyone who wants a glassy, transparent VSCode setup... | - | 2 |
...
| [sunrisever/vscode-frosted-glass](https://github.com/sunrisever/vscode-frosted-glass) | VS Code frosted glass transparency setup (Windows) \| VSCode 毛玻璃透明效果配置 | PowerShell | 1 |

## New List: Fonts

*Fonts specifically designed for programming or with programming-related features.*
...
| [Dan1elTheMan1el/IOS-Shortcuts](https://github.com/Dan1elTheMan1el/IOS-Shortcuts) | Repo to track my shortcut files/updates | HTML | 10 |
...
| [sahilsatralkar/ContextComposer](https://github.com/sahilsatralkar/ContextComposer) | Context Composer is an iOS app built using Foundation Models that transforms mes... | Swift | 3 |
